...
const Footer = () => {
  return (
    <footer className="container-xl" style={{ paddingTop: "250px" }}>
      <div className="row ml-136">
        <div className="col-6 col-md-3 mb-3">
          <p>Jalan Suryono No.161 Mayangan Kota Probolinggo 672000</p>
        ...
        <div className="col-6 col-md-3 mb-3">
          ...
          <ul
            ...
            style={{ listStyle: "none", paddingLeft: 0, maxWidth: "15rem" }}
          >
            <li>
              <a href="">
                <svg
